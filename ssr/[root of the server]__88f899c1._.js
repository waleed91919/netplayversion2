...
"[project]/.next-internal/server/app/anime/page/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/anime/page.tsx [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getData() {
    try {
        // For anime, we'll filter TV shows from Japan (JP) or with animation genre
        // Animation genre ID is 16
        const [animeGenres, tvGenres] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$tmdb$2d$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["apiEndpoints"].getTVSeriesByGenre(16, 1),
        ...
        const animeShows = animeGenres.data.results.filter((show)=>show.original_language === 'ja');
        return {
            anime: animeShows,
...
async function AnimePage() {
    const { anime, genres } = await getData();
...
"[project]/src/app/anime/page.tsx [app-rsc] (ecmascript, Next.js server component)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/anime/page.tsx [app-rsc] (ecmascript)"));
}}),

};

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__88f899c1._.js.map